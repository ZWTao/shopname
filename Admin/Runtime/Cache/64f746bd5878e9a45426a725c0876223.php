		...
		<div class="container-fluid">
			<!-- <div class="row-fluid">
				<div class="span3 offset9" >
					<button class="btn"> 旅行项目发布</button>
				</div>
			</div> -->
			<div class="row-fluid">
				<div class="span12">
				...
				<div class="modal-dialog modal-lg">
					<div class="modal-content">
						...
						<form action="__URL__/inspecial"  method="post"  enctype="multipart/form-data" class="form-horizontal">
							...
							<br>
							<div >
								<textarea  id='gdescription1' cols='70' rows='4' name="gdescription1" placeholder='享受美好旅行，从现在开始；'></textarea></div>
						<div class="modal-footer" style="text-align:center;">
							<button type="submit" class="btn btn-primary" >保存</button>
						</div>
						</form>
